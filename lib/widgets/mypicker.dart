...
class DatePicker2 extends StatefulWidget {
  ...
  final DatePickerController2? controller;
  ...
  @override
  State<StatefulWidget> createState() => new _DatePickerState2();
}
...
class _DatePickerState2 extends State<DatePicker2> {
  ...
  Widget build(BuildContext context) {
    var proejctProvider = Provider.of<ProjectProvider>(context);
    return Container(
...
//            print("Inside Inactive dates.");
          ...
          bool isSelected = proejctProvider.selectedDate != null
              ? _compareDate(date, proejctProvider.selectedDate)
              : false;
          ...
          return DateWidget(
            ...
            onDateSelected: (selectedDate) {
              ...
              proejctProvider.setSelectedDate(selectedDate);
            },
          );
        },
      ),
...
class DatePickerController2 {
  _DatePickerState2? _datePickerState;

  void setDatePickerState(_DatePickerState2 state) {
