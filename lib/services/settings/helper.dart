...
class SettingsHelper {
  TextEditingController email = new TextEditingController()..text = profileData!.email!;
  TextEditingController first_name = new TextEditingController()..text = profileData!.firstName!;
  TextEditingController last_name = new TextEditingController()..text = profileData!.lastName!;
